...
# import itn_model
#valid_tags = ["Addr-Building-Number","Addr-Block" , "Addr-Bld", "Addr-Street", "PostCode", "Addr-Region","Addr-Building-Name", "Addr-UnitNo", "Addr-city", "AGE", "INJURY", "Addr-Block", "IC", "COUNT"]
valid_tags =  ["WEAPON", "AGE", "CHARATERISTIC" , "EMERGENCY","Addr-Building-Number","Addr-Block" , "Addr-Bld", "Addr-Street", "PostCode", "Addr-Region","Addr-Building-Name", "Addr-UnitNo", "Addr-city", "Addr-Block","TRAIT"]
